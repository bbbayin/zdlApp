...
public class HealthFragment extends MvpBaseFragment<FunIterface, BaseListPresenter> implements FunIterface, SwipeRefreshLayout.OnRefreshListener, OnMoreListener {
...
//    public ContentLoadingProgressBar mLoadingDrawable;
    ...
    protected void initView(View inflate, Bundle savedInstanceState) {
        ...
        mCollapsingToolbarLayout.setTitle("健康资讯");
...
//        mLoadingDrawable.setVisibility(View.GONE);
    ...
    public static void launch(Activity from, Bundle bundle) {
        ...
        bundle.putString(Constants.FRAGMENT_TITLE, "健康资讯");
        ContainerActivity.launch(from, HealthFragment.class, bundle);
    }
